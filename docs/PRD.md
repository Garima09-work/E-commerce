...
For technical architecture and database schemas, see [Technical Requirements Document (`docs/TRD.md`)](./TRD.md). For design rationale, see [Research Paper (`docs/RESEARCH_PAPER.md`)](./RESEARCH_PAPER.md).
